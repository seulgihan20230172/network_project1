...
output_graph_dir = "network_analysis/BA/graph"  # 그래프를 저장할 폴더
output_derivative_dir = "network_analysis/BA/Derivative_graph"  # 기울기를 저장할 폴더
output_dd_derivative_dir = (
    "network_analysis/BA/D_Derivative_graph"  # 두 번째 미분을 저장할 폴더
)
final_remaining_edges_file = "network_analysis/BA/final_remaining_edges.csv"  # 마지막 remaining edges를 저장할 파일
