...
# 파일 경로 설정
ba_network_dir = "repeat_num/DongBA_result/DongBA//BA_random_network_results"
er_network_dir = "repeat_num/DongER_result/ER_random_network_results"
output_combined_graph_dir = "network_analysis/synthesize/BA_ER"
...
# BA 및 ER 네트워크 파일 리스트
ba_network_files = [
    f"{ba_network_dir}/BA_network_{i}_average_shortest_paths.csv" for i in range(1, 51)
]
er_network_files = [
