...
# 파일 경로 설정
network_dir = "repeat_num/DongWS_result/DongWS/WS_random_network_results"  # 네트워크 파일들이 있는 폴더 경로
output_graph_dir = "network_analysis/WS"  # 평균 그래프를 저장할 폴더
os.makedirs(output_graph_dir, exist_ok=True)

# 네트워크 파일 리스트
network_files = [
    f"{network_dir}/WS_network_{i}_average_shortest_paths.csv" for i in range(1, 51)
]
...
print(f"Number of WS networks with length ≤ 2425: {count_below_2425}")
"""
